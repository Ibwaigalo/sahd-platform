...
export default function HomePage() {
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-32 pb-16">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-accent-orange/20 border border-accent-orange/30 text-accent-orange px-4 py-2 rounded-full text-sm font-semibold mb-6">
                 ...
                 <h1 className="text-4xl sm:text-5xl xl:text-6xl font-black text-white leading-tight mb-4">
                  ...
                  <span className="text-gradient-orange">Développement</span>
                </h1>
            ...
            >
              {/* Countdown */}
              <div className="bg-gradient-to-br from-primary-900/80 to-primary-700/60 
                backdrop-blur-xl border border-accent-orange/40 
                rounded-3xl p-10 shadow-2xl shadow-orange-500/30">
  <p className="text-accent-orange font-bold text-lg mb-6 text-center uppercase tracking-widest">
    🚀 Compte à rebours
  </p>
  ...
  {stats.map((stat, i) => (
    <motion.div
      ...
      className="bg-gradient-to-br from-primary-900/40 to-primary-700/30 
                 backdrop-blur-xl border border-white/20 rounded-3xl 
                 p-6 text-center shadow-xl shadow-orange-500/20 
                 hover:scale-105 transition-transform"
    >
      <div className="text-3xl mb-2">{stat.icon}</div>
      <div className="text-4xl font-extrabold text-accent-orange">{stat.value}</div>
