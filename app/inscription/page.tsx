...
export default function InscriptionPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      if (existingProfile) {
        toast.error('Cet email est déjà inscrit. Connectez-vous à votre espace.')
        setLoading(false)
        return
      }
      ...
      setSubmitted(true)
      toast.success('Inscription réussie ! Email de confirmation envoyé.')
      ...
      <div className="pt-20 min-h-screen flex items-center justify-center bg-gray-50 px-4">
        ...
        >
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 mb-6 text-left">
            ...
            <p className="text-blue-600 text-sm">Un email de confirmation vous a été envoyé depuis admin@sahd-mali.org</p>
          </div>
