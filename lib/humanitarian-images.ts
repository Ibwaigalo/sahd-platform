...
export const mediaPhotos = [
  { id: 1, url: 'https://images.unsplash.com/photo-1593113598332-cd288d649433?w=800&h=600&fit=crop', captionFr: 'Distribution d\'aide alimentaire au Mali', captionEn: 'Food aid distribution in Mali' },
  { id: 2, url: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?w=800&h=600&fit=crop', captionFr: 'Volontaires en action', captionEn: 'Volunteers in action' },
  { id: 3, url: 'https://images.unsplash.com/photo-1559027615-cd4628902d4a?w=800&h=600&fit=crop', captionFr: 'Enfants dans un camp de réfugiés', captionEn: 'Children in refugee camp' },
  { id: 4, url: 'https://images.unsplash.com/photo-1469571486292-0ba58a3f068b?w=800&h=600&fit=crop', captionFr: 'Aide médicale d\'urgence', captionEn: 'Emergency medical aid' },
  { id: 5, url: 'https://images.unsplash.com/photo-1584515933487-779824d29309?w=800&h=600&fit=crop', captionFr: 'Sensibilisation communautaire', captionEn: 'Community awareness' },
  { id: 6, url: 'https://images.unsplash.com/photo-1509099836639-18ba1795216d?w=800&h=600&fit=crop', captionFr: 'Formation des agents de santé', captionEn: 'Health workers training' },
  { id: 7, url: 'https://images.unsplash.com/photo-1532629345422-7515f3d16bb6?w=800&h=600&fit=crop', captionFr: 'Éducation pour tous', captionEn: 'Education for all' },
